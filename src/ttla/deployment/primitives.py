...
REAL_CARRY_QPOS = np.deg2rad(np.asarray([0.0, -8.0, 96.0, -8.0, 0.0, 174.0], dtype=np.float32))
REAL_PREGRASP_ANCHOR_QPOS = np.deg2rad(np.asarray([0.0, 22.0, 112.0, -6.0, 0.0, 158.0], dtype=np.float32))
REAL_DROPZONE_HOVER_QPOS = np.deg2rad(np.asarray([-20.0, 6.0, 139.0, -12.0, 0.0, 174.0], dtype=np.float32))
REAL_PLACE_RELEASE_QPOS = np.deg2rad(np.asarray([-20.0, 10.0, 148.0, -8.0, 0.0, 174.0], dtype=np.float32))
...
REAL_GRIPPER_CLOSED_QPOS = np.deg2rad(np.float32(174.0))
