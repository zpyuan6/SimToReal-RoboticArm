...
VARIANTS = [
    {"name": "gate_id_000", "overrides": {"adaptation": {"gate_identity_weight": 0.0}}},
    {"name": "gate_id_001", "overrides": {"adaptation": {"gate_identity_weight": 0.001}}},
    {"name": "gate_id_005", "overrides": {"adaptation": {"gate_identity_weight": 0.005}}},
    {"name": "gate_id_010", "overrides": {"adaptation": {"gate_identity_weight": 0.01}}},
    {"name": "gate_id_020", "overrides": {"adaptation": {"gate_identity_weight": 0.02}}},
]
...
def _prepare_cfg(base_cfg: dict, variant_name: str) -> tuple[dict, Path]:
    ...
    root = ensure_dir(Path(cfg["paths"]["results_root"]) / "joint_gate_sweep" / variant_name / "feedforward")
...
def main() -> None:
    ...
    out_root = ensure_dir(Path(base_cfg["paths"]["results_root"]) / "joint_gate_sweep")
